...
public int New_ (int p_usuario_0, Nullable<DateTime> p_Fecha, float p_Valor, string p_Prueba, int p_Votos, int p_Reportes, int p_reto, int p_Pos, string p_Premio)
{
        VictoriaEN victoriaEN = null;
        int oid;
