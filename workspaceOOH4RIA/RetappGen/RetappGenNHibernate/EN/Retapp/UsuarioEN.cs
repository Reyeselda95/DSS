...
public UsuarioEN(int id, System.Collections.Generic.IList<RetappGenNHibernate.EN.Retapp.ParticipacionEN> participacionesVotadas, System.Collections.Generic.IList<RetappGenNHibernate.EN.Retapp.ParticipacionEN> participacionesEnviadas, string gaccount, int tlf, Nullable<DateTime> fechaBaneado, string nombre, int numBaneos, string direccion, bool baneado, int votos, float karma, int codPstal, Nullable<DateTime> fechaLogin
                 )
{
        this.init (Id, participacionesVotadas, participacionesEnviadas, gaccount, tlf, fechaBaneado, nombre, numBaneos, direccion, baneado, votos, karma, codPstal, fechaLogin);
}


public UsuarioEN(UsuarioEN usuario)
{
        this.init (Id, usuario.ParticipacionesVotadas, usuario.ParticipacionesEnviadas, usuario.Gaccount, usuario.Tlf, usuario.FechaBaneado, usuario.Nombre, usuario.NumBaneos, usuario.Direccion, usuario.Baneado, usuario.Votos, usuario.Karma, usuario.CodPstal, usuario.FechaLogin);
}

private void init (int id, System.Collections.Generic.IList<RetappGenNHibernate.EN.Retapp.ParticipacionEN> participacionesVotadas, System.Collections.Generic.IList<RetappGenNHibernate.EN.Retapp.ParticipacionEN> participacionesEnviadas, string gaccount, int tlf, Nullable<DateTime> fechaBaneado, string nombre, int numBaneos, string direccion, bool baneado, int votos, float karma, int codPstal, Nullable<DateTime> fechaLogin)
{
        this.Id = id;
