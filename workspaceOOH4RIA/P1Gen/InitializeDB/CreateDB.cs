...
public static void InitializeData ()
{
        ...
        try
        {
                /*List<P1GenNHibernate.EN.Mediaplayer.MusicTrackEN> musicTracks = new List<P1GenNHibernate.EN.Mediaplayer.MusicTrackEN>();
                 * P1GenNHibernate.EN.Mediaplayer.UserEN userEN = new P1GenNHibernate.EN.Mediaplayer.UserEN();
                 * P1GenNHibernate.EN.Mediaplayer.ArtistEN artistEN = new P1GenNHibernate.EN.Mediaplayer.ArtistEN();
                 * P1GenNHibernate.EN.Mediaplayer.MusicTrackEN musicTrackEN = new P1GenNHibernate.EN.Mediaplayer.MusicTrackEN();
                 * P1GenNHibernate.CEN.Mediaplayer.ArtistCEN artistCEN = new P1GenNHibernate.CEN.Mediaplayer.ArtistCEN();
                 * P1GenNHibernate.CEN.Mediaplayer.UserCEN userCEN = new P1GenNHibernate.CEN.Mediaplayer.UserCEN();
                 * P1GenNHibernate.CEN.Mediaplayer.MusicTrackCEN musicTrackCEN = new P1GenNHibernate.CEN.Mediaplayer.MusicTrackCEN();
                 * P1GenNHibernate.CEN.Mediaplayer.PlayListCEN playListCEN = new P1GenNHibernate.CEN.Mediaplayer.PlayListCEN();
                 *
                 *              //Add Users
                 ...
                 *
                 * //Define Album
                 * //P1GenNHibernate.CEN.Mediaplayer.AlbumCEN albumCEN = new P1GenNHibernate.CEN.Mediaplayer.AlbumCEN();
