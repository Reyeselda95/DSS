...
public ProductoEN(int productoId, string nombre, string descripcion, float precio, int stock, System.Collections.Generic.IList<InariPlaysGenNHibernate.EN.Prueba.LiniaPedidoEN> liniaPedido, System.Collections.Generic.IList<InariPlaysGenNHibernate.EN.Prueba.CestaEN> cesta, InariPlaysGenNHibernate.EN.Prueba.VideojuegoEN videojuego, InariPlaysGenNHibernate.EN.Prueba.MusicaEN musica, InariPlaysGenNHibernate.EN.Prueba.MerchandisingEN merchandising, InariPlaysGenNHibernate.EN.Prueba.PeliculaEN pelicula)
{
        this.init (productoId, nombre, descripcion, precio, stock, liniaPedido, cesta, videojuego, musica, merchandising, pelicula);
}


public ProductoEN(ProductoEN producto)
{
        this.init (producto.ProductoId, producto.Nombre, producto.Descripcion, producto.Precio, producto.Stock, producto.LiniaPedido, producto.Cesta, producto.Videojuego, producto.Musica, producto.Merchandising, producto.Pelicula);
}

private void init (int productoId, string nombre, string descripcion, float precio, int stock, System.Collections.Generic.IList<InariPlaysGenNHibernate.EN.Prueba.LiniaPedidoEN> liniaPedido, System.Collections.Generic.IList<InariPlaysGenNHibernate.EN.Prueba.CestaEN> cesta, InariPlaysGenNHibernate.EN.Prueba.VideojuegoEN videojuego, InariPlaysGenNHibernate.EN.Prueba.MusicaEN musica, InariPlaysGenNHibernate.EN.Prueba.MerchandisingEN merchandising, InariPlaysGenNHibernate.EN.Prueba.PeliculaEN pelicula)
{
