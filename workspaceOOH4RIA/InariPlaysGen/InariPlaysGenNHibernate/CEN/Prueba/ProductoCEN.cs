...
public int Crear (int p_productoId, string p_nombre, string p_descripcion, float p_precio, int p_stock)
{
...
public void Modificar (int p_Producto_OID, string p_nombre, string p_descripcion, float p_precio, int p_stock)
{
        ProductoEN productoEN = null;
