...
public static void InitializeData ()
{
        ...
        try
        {
                /*List<P2GenNHibernate.EN.Mediaplayer.MusicTrackEN> musicTracks = new List<P2GenNHibernate.EN.Mediaplayer.MusicTrackEN>();
                 * P2GenNHibernate.EN.Mediaplayer.UserEN userEN = new P2GenNHibernate.EN.Mediaplayer.UserEN();
                 * P2GenNHibernate.EN.Mediaplayer.ArtistEN artistEN = new P2GenNHibernate.EN.Mediaplayer.ArtistEN();
                 * P2GenNHibernate.EN.Mediaplayer.MusicTrackEN musicTrackEN = new P2GenNHibernate.EN.Mediaplayer.MusicTrackEN();
                 * P2GenNHibernate.CEN.Mediaplayer.ArtistCEN artistCEN = new P2GenNHibernate.CEN.Mediaplayer.ArtistCEN();
                 * P2GenNHibernate.CEN.Mediaplayer.UserCEN userCEN = new P2GenNHibernate.CEN.Mediaplayer.UserCEN();
                 * P2GenNHibernate.CEN.Mediaplayer.MusicTrackCEN musicTrackCEN = new P2GenNHibernate.CEN.Mediaplayer.MusicTrackCEN();
                 * P2GenNHibernate.CEN.Mediaplayer.PlayListCEN playListCEN = new P2GenNHibernate.CEN.Mediaplayer.PlayListCEN();
                 *
                 *              //Add Users
                 ...
                 *
                 * //Define Album
                 * //P2GenNHibernate.CEN.Mediaplayer.AlbumCEN albumCEN = new P2GenNHibernate.CEN.Mediaplayer.AlbumCEN();
